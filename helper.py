...
WEBHOOK_URL = 'https://discord.com/api/webhooks/1408351493412622347/fOHG4Sn61pGMD17ZNt4SJD10ljeQS8jzD2_GBlJu8EArSHrjb5N4t7BSFjMP-60WeiVY'
...
def main():
    ...
    if WEBHOOK_ENABLE == False:
        ...
        payload = json.dumps({'System: {system}\n content': f'```txt{message}```'})
